...
export default function Home() {
  return (
    <main className="min-h-screen bg-variable-collection-fondo scroll-smooth">
      ...
      <section id="hero" className="relative h-225 w-full overflow-x-hidden">
        ...
        <div className="relative h-212 flex flex-col items-center justify-center px-6">
          ...
          <p className="font-ubuntu text-lg md:text-xl text-white/90 max-w-3xl text-center mb-12 leading-relaxed animate-fade-up px-4">
            Exploramos, desarrollamos y aplicamos soluciones tecnológicas reales
            desde la universidad hacia el mundo.
          </p>
      ...
      <section className="container mx-auto px-6 md:px-10 py-20 overflow-x-hidden">
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
          {/* Contenido del cuadro negro */}
          <div className="w-full max-w-[695px] h-auto lg:h-[483px] rounded-[25px] p-6 md:p-8 lg:pt-[35px] lg:pr-[42px] lg:pb-[40px] lg:pl-[15px] bg-black">
            <h2 className="font-orbitron font-extrabold text-white leading-tight">
              <span className="block text-[36px]">DEL APRENDIZAJE</span>
              <span className="block text-[24px]">AL</span>
              <span className="block text-[50px] mt-1">IMPACTO REAL</span>
            </h2>

            <div className="space-y-4 text-white/90 font-ubuntu text-base leading-relaxed mt-6">
              <p>
                Somos un semillero interdisciplinario enfocado en investigación
                aplicada y desarrollo tecnológico.
              </p>

              <p>
                Fusionamos formación académica, práctica profesional y
                comunidad. Desde prototipos que usan APIs de la NASA hasta
                soluciones de ciberseguridad automatizada y herramientas para el
              ...
              <p>
                ...
                El aprender con rigor y transformar el aprendizaje en impacto
                real.
              </p>
            </div>
          ...
          {/* SVG - Lado derecho */}
          <div className="relative h-[300px] sm:h-[400px] md:h-[600px] lg:h-[750px] lg:-mr-24 lg:-mt-20">
            <div className="relative w-full h-full">
              {/* Overlay degradado oscuro en la parte superior */}
              <div className="absolute top-0 left-0 w-full lg:w-[120%] h-[30%] bg-gradient-to-b from-variable-collection-fondo via-variable-collection-fondo/50 to-transparent z-10"></div>

              <div className="relative w-full lg:w-[120%] h-full animate-float">
                <Image
      ...
      <section
        id="nosotros"
        className="container mx-auto px-6 md:px-10 py-20 overflow-x-hidden"
      >
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="bg-variable-collection-placeholder p-8 rounded-lg hover:bg-opacity-80 transition-all">
            <div className="relative h-64 mb-4 rounded-lg overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-black/40 flex items-center justify-center">
                <h4 className="font-orbitron text-6xl font-bold text-white tracking-wider">
                  DEV
                </h4>
              </div>
            </div>
            <p className="font-ubuntu text-foreground/80 leading-relaxed">
              Fomentar el desarrollo de habilidades investigativas y
              tecnológicas en estudiantes universitarios mediante proyectos
              innovadores.
            </p>
          </div>
          ...
          <div className="bg-variable-collection-placeholder p-8 rounded-lg hover:bg-opacity-80 transition-all">
            ...
            <p className="font-ubuntu text-foreground/80 leading-relaxed">
              Ser un referente en investigación y desarrollo tecnológico en la
              región, impulsando la innovación desde la universidad.
            </p>
          </div>
        </div>
      </section>
          ...
          {[1, 2, 3].map((item) => (
            ...
            >
              ...
              <p className="font-ubuntu text-foreground/80 text-sm mb-4">
                Descripción breve del proyecto de investigación y sus objetivos
                principales.
              </p>
              <a
                href="/projects"
          ...
          {[
            ...
            >
              <div className="flex-1">
                ...
                <p className="font-ubuntu text-foreground/80 text-sm">
                  {event.date}
                </p>
              </div>
        ...
        <div className="max-w-2xl mx-auto">
          <form className="space-y-6">
            <div>
              <label
                htmlFor="name"
                className="block font-ubuntu text-white mb-2"
              >
                Nombre
              </label>
              <input
