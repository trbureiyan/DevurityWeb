...
export default function Footer() {
  return (
    <footer className="relative bg-variable-collection-fondo border-t border-white/5 mt-auto overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#ff000008] via-transparent to-transparent pointer-events-none" />
      ...
      <div className="relative max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8 md:py-12">
        ...
        {/* Bottom Bar */}
        <div className="pt-6 border-t border-white/5 text-center flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-ubuntu text-xs text-[#9ca3af]">
            © {new Date().getFullYear()} Devurity. Todos los derechos reservados.
          </p>
          <div className="flex items-center gap-6">
            ...
            <div className="relative w-6 h-6 rounded overflow-hidden">
              <Image
                src="/images/devurity-iso.png"
                alt="Devurity Isotipo"
                fill
                sizes="24px"
